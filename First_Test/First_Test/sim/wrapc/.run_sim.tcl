...
set ::env(LD_LIBRARY_PATH) /software/CAD/Xilinx/2018.2/Vivado/2018.2/lnx64/tools/fpo_v7_0:$::env(LD_LIBRARY_PATH)
set ::env(LD_LIBRARY_PATH) /software/CAD/Xilinx/2018.2/Vivado/2018.2/lnx64/tools/opencv:$::env(LD_LIBRARY_PATH)
set ::env(LD_LIBRARY_PATH) /software/CAD/Xilinx/2018.2/Vivado/2018.2/lnx64/tools/fft_v9_1:$::env(LD_LIBRARY_PATH)
set ::env(LD_LIBRARY_PATH) /software/CAD/Xilinx/2018.2/Vivado/2018.2/lnx64/tools/fir_v7_0:$::env(LD_LIBRARY_PATH)
set ::env(LD_LIBRARY_PATH) /software/CAD/Xilinx/2018.2/Vivado/2018.2/lnx64/tools/dds_v6_0:$::env(LD_LIBRARY_PATH)
...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "hls_main.autotvin.dat"
	set constFileTvOut       "hls_main.autotvout.dat"
	set constFileHdlTvIn     "hls_main.autohdltvin.dat"
	set constFileHdlTvOut    "hls_main.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
